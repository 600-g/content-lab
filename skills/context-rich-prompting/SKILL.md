...
AI에게 일반적인 역할을 부여하기보다, 구체적인 상황과 맥락을 제공하여 답변 품질을 즉시 향상시키는 프롬프트 작성 원리입니다. Use when: - AI의 답변이 너무 일반적이거나 기대에 못 미칠 때 - 특정 상황에 맞춰진 구체적이고 실용적인 답변이 필요할 때 - AI 활용의 효율성을 극대화하고 싶을 때
